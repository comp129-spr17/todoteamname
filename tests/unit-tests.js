...
function run_tests() {
    ...
    console.log("Testing Server Filter...");
	$.post('/tests/filter_test.php', input_for_server_filter, function(testData) {
        ...
        // Check if the received results match the expected results
    ...
    console.log("Testing Level Filter...");
    ...
    console.log("Testing Server and Language Filter...");
    ...
    // TODO add tests for mic, competitive and mature when the "Any" option is added
};
